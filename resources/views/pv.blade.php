            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">the PV Module</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="">
                        <h3><span class="highlight">OFF-GRID</span> and <span class="highlight">HYBRID</span> Solar Power Systems</h3>
                    </div>
                    <div class="">
                        <h3><span class="highlight">OFF-GRID PV System</span></h3>
                    </div>
                    <p>
                    ...
                    <img src="{{url('img/offgrid.png')}}" alt="" class="img-responsive" />
                    <div class="">
                        <h3><span class="highlight">HYBRID -Connected PV System</span></h3>
                    </div>
                    <p>
